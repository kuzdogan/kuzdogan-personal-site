...
date: 2023-02-22
summary: What to do, what to eat from my experience in Tokyo, Kyoto, and Hakuba.
tags:
  - Travel
  - Food
  - Japan
...
>
  <img
    src="/images/older/view.jpg"
    alt="view from the Tokyo Metropolitan Government Building"
    style={{ maxWidth: '600px', width: '100%', height: 'auto', margin: '0' }}
  />
  <p>View from the Tokyo Metropolitan Government Building</p>
</div>
...
>
  <img
    src="/images/older/ramen.jpg"
    alt="Me devouring a convenience store ramen"
    style={{ maxWidth: '400px', width: '100%', height: 'auto', margin: '0' }}
  />
  <p>Me devouring a convenience store ramen</p>
</div>
