...
date: 2020-11-29
summary: With the new update of Google Analytics in Oct 2020 things have changed a little as to how to add Google Analytics to your website.
tags:
  - Gatsby
  - Google Analytics
images: ['/images/older/google-analytics.png']
layout: PostBanner
---
...
![Image showing where to click in the Analytics dashboard](/images/older/ga-dashboard.jpg)

There you will see the **Measurement ID**. We just need that.

![Image showing where to find the Measurement ID](/images/older/ga-dashboard2.jpg)
